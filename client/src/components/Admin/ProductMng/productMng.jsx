...
//     discountPercent: '',
//     isTodaysDeal: false,
//     bulkOrderAvailable: false // Added bulk order checkbox field
//   });
...
//           discountPercent: '',
//           isTodaysDeal: false,
//           bulkOrderAvailable: false // Reset bulk order checkbox
//         });
//         document.getElementById("fileInput").value = "";
//       } else {
//         console.error('Failed to add product:', result.message);
...
//       discountPercent: product.discountPercent || '',
//       isTodaysDeal: product.isTodaysDeal || false,
//       bulkOrderAvailable: product.bulkOrderAvailable || false // Populate bulk order checkbox
//     });
//   };
...
//     <label>
//       <input type="checkbox" name="bulkOrderAvailable" checked={formData.bulkOrderAvailable} onChange={handleInputChange} />
...
//               {/* <td>{product.rating}</td>
//               <td>{product.reviewCount}</td> */}
//               <td><img className={styles.imgg} src={product.image} alt={product.name} width="50" /></td>
//               <td>
//                 <button className={styles.button} onClick={() => handleEditClick(product)}>Edit</button>
//                 <button className={styles.button} onClick={() => handleDeleteProduct(product._id)}>Delete</button>
//               </td>
