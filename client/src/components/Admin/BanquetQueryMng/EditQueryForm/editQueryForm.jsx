...
const EditQueryForm = ({ query, onSave, onCancel }) => {
  ...
  const handlePreferredTimingsChange = (field, value) => {
    setFormData({
      ...formData,
      preferredTimings: {
  ...
  return (
    <form className={styles.editForm} onSubmit={handleSubmit}>
      ...
      <label>Selected Menu:</label>
      <input type="text" name="selectedCart" value={formData.selectedCart} onChange={handleChange} />
      ...
      <div className={styles.timeSelection}>
        <input
          type="time"
          value={formData.preferredTimings?.start || ""}
          onChange={(e) => handlePreferredTimingsChange("start", e.target.value)}
          className={styles.timeInput}
        />
        <span>to</span>
        <input
          type="time"
          value={formData.preferredTimings?.end || ""}
          onChange={(e) => handlePreferredTimingsChange("end", e.target.value)}
          className={styles.timeInput}
        />
      </div>
      ...
      <button className={styles.first} type="submit">Save</button>
      <button className={styles.sec} type="button" onClick={onCancel}>Cancel</button>
    </form>
  );
};
