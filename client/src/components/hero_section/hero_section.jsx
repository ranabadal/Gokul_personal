...
const CountdownTimer = () => {
  ...
  return (
    <div className={styles.hero_section_left_bottom}>
      <span className={styles.hero_section_left_bottom_box}>
  ...
  const slides = [
    {
      ...
      description:
        "Elevate every occasion with Gokul, where we offer premium gifts that illuminate life’s special moments.",
      image: box,
    ...
    },
    {
      ...
      description:
        "Discover the joy of gifting with our exclusive Diwali offers.",
      image: box,
      timer: <CountdownTimer />,
    },
    {
    ...
    <div>
        ...
        <div className={styles.hero_section}>
          ...
          <div className={styles.hero_section_left}>
            <div className={styles.hero_section_left_div_1}>
              <div className={styles.hero_section_left_top}>
          ...
          <div className={styles.hero_section_right_container}>
            <h2 className={styles.hero_section_right_title}>
          ...
          <button
            className={styles.hero_section_bttn_right}
            onClick={nextSlide}
          >
            <span>&rarr;</span>
          </button>
      ...
      <div className={styles.hero_section_bottom_dots}>
        {slides.map((_, index) => (
          <div
            key={index}
            className={`${styles.hero_section_bottom_dot} ${
