...
//         <span
//           className={selectedCategory === "Sweets" ? styles.activeFilter : styles.filter}
//           onClick={() => setSelectedCategory("Sweets")}
//         >
//           Sweets
//         </span>
//         <span
//           className={selectedCategory === "Restaurant" ? styles.activeFilter : styles.filter}
...
//     <h2 className={styles.sectionSweetsTitle}>Sweets</h2>
...
//         <p>{errorProducts}</p>
//       ) : (
//         products.filter((product) => product.category === "Sweets")
//           .map((product) => (
...
//               <p>{errorProducts}</p>
//             ) : (
//               products.filter((product) => product.category === "Restaurant" && (!selectedSubcategory || product.subcategory === selectedSubcategory))
//                 .map((product) => (
//                   <div key={product._id} className={styles.productCard}>
//                     <div className={styles.productImageWrapper}>
//                     <img src={product.image} alt={product.name} className={styles.productImage} />
