        ...
        <div className={styles.container}>
            ...
            <div className={styles.subcontainer}>
                <div className={styles.subcontainercard1}>
                    <div className={styles.subcontainercardorder}>Ambala Cantt</div>
                ...
                <div className={styles.subcontainercard3}>
                    <div className={styles.subcontainercardorder}>Chandigarh</div>
                    <div className={styles.subcontainercardtitle}>Coming Soon</div>
                    <div className={styles.subcontainercardimg}>
                        <img src={Arrow} alt="Arrow"></img>
                    </div>
                </div>
