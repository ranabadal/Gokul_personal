...
// import topRightImage from './Assets/top-right1.png'; // adjust the path if needed
...
//         >
//           <img src={topRightImage} alt="Decoration" className={styles.topRightImage} />
//           <div className={styles.topRightHeading}>Gokul's Banquet Halls</div>
    
//           {isLoading && <Loader />}
//           {error && <div className={styles.error}>Error: {error}</div>}
    
//           <div className={styles.banquetsContainer}>
//   {!isLoading && !error && banquets.map((banquet) => (
//     <div key={banquet._id} className={styles.hall_details}>
//       <HallDetails
//         name={banquet.title}
//         price={`Min. Charges : ₹ ${banquet.price}`}
//         seating={`${banquet.seatingCapacity} Seating`}
