...
//             <TextField fullWidth label="User Name" variant="outlined" className={styles.inputField} />
//           </div>
//           <div className={styles.inputContainer}>
//             <TextField fullWidth label="Password" type="password" variant="outlined" className={styles.inputField} />
//             {/* <Visibility className={styles.eyeIcon} /> */}
//           </div>
//           <p className={styles.forgotPassword}>Forgot password?</p>
//           <Button fullWidth className={styles.loginButton}>Login</Button>
...
//           <TextField fullWidth label="User Name" variant="outlined" className={styles.inputField} />
//           <TextField fullWidth label="Phone No." variant="outlined" className={styles.inputField} />
//           <TextField fullWidth label="Email" variant="outlined" className={styles.inputField} />
//           <TextField fullWidth label="Password" type="password" variant="outlined" className={styles.inputField} />
//           <Button fullWidth className={styles.signupButton}>Sign Up</Button>
//           <div className={styles.dividerContainer}>
//             <span className={styles.divider}></span>
//             <p className={styles.orText}>Or Login with</p>
//             <span className={styles.divider}></span>
...
//         // localStorage.setItem('user', JSON.stringify({ name: result.name, profilePic: result.profilePic, jwtToken: result.token }));
