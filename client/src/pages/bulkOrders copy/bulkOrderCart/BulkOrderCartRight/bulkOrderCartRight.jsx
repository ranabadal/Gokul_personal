...
import styles from "./bulkOrderCartRight.module.css";
import editIcon from "../../../giftBoxes/giftBoxCart/giftBoxCartRight/Assets/editIcon.svg";
import deleteIcon from "../../../giftBoxes/giftBoxCart/giftBoxCartRight/Assets/delete.svg";
...
useEffect(() => {
    if(refreshSummaryForm){
        setStoredSelections(JSON.parse(localStorage.getItem("bulkOrderSelections")) || []);
...
useEffect(() => {
    ...
    const total = storedSelections.reduce((sum, box) => {
      const sweetsTotal = box.selectedSweets.reduce(
        (sweetsSum, sweet) => sweetsSum + sweet.price, 0
      );
  ...
  return (
   ...
   <div className={styles.selectedBoxNameAndSizeAndicons}>
